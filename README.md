...
Body:
  {
    ...
    date: <string> 2018-08-02 (YYYY-MM-DD),
    diabetes: <number> 80.0 (Risk score percentile compared across all available users)
    sleep_apnea: <number> 56.0
    hypertension: <number> 89.0
  }
